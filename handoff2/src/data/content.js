export const COLORS = { crema: '#F4EDE4', tinta: '#2D1515', rojo: '#B93232' };

export const ASSETS = '/assets/conocer-mas';

// Orden del carril derecho (se repiten para alargar el recorrido)
export const PHOTOS = [
...
export const SUBTEMAS = [
  {
    ...
    blocks: [
      ...
      { type: 'intro' }, // se renderiza INTRO y es el párrafo que se fija
    ],
  },
  {
    id: 'pro-positum',
