// Clases compartidas del sistema (Tailwind)
export const cls = {
  ...
  // Geometría del bloque del logo (mantener idéntica entre componentes)
  maskH: 'h-[calc(min(44px,2.3vw)+min(130px,9.8vw)+2px)]',
  pinTop: 'top-[calc(min(44px,2.3vw)+min(130px,9.8vw)+6px)]',
