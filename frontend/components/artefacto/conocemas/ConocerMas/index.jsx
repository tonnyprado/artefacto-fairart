...
import { HERO, LOGO, PHOTOS } from './content';
  ...
  const SUBTEMAS = [
    {
      ...
      etim: [
        {
          word: 'ars/artis',
          def: '(lat.) habilidad, oficio o técnica aprendida a través de la práctica.'
        },
        {
          word: 'factum/factus',
          def: '(lat.) lo hecho, lo fabricado.'
        },
      ],
      blocks: [
        {
          type: 'etimExtra',
          word: 'arte factum',
          def: '(lat.) Confeccionado con técnica y hecho con arte.'
        },
        { type: 'intro' },
      ],
    },
    {
      ...
      etim: [
        {
          word: 'pro',
          def: '(lat.) delante, al frente, a la vista de todos.'
        },
        {
          word: 'pósitum',
          def: '(lat.) lo puesto, lo colocado.'
        },
      ],
      blocks: [
        ...
        {
          type: 'p',
          strongLead: 'ARTE FACTO',
          text: ' es para artistas cuyo concepto y técnica se desarrollan con el mismo rigor — donde uno no existe sin el otro. Aquí, lo conceptual y lo técnico ponderan en un mismo nivel, vengas de la figuración, la abstracción o cualquier territorio intermedio, con estudios o años de prueba y error. Valoramos el camino que haya seguido tu práctica: es la construcción del arte al que has llegado con trabajo, atención y convicción.'
        },
      ],
    },
    {
      ...
      etim: [
        {
          word: 'diá',
          def: '(gr.) a través de, por medio de.'
        },
        {
          word: 'gnōsis',
          def: '(gr.) conocimiento.'
    ...
    },
    {
      ...
      etim: [
        {
          word: 'ethos',
          def: '(gr.) carácter, modo de ser.'
        },
        {
          word: 'creare',
          def: '(lat.) producir, engendrar, hacer existir.'
        },
      ],
      blocks: [
  ...
  useEffect(() => {
    ...
    const placePin = () => {
      ...
      try {
        ...
        if (r.width > 100) {
          // Copiar exactamente la posición horizontal del flow
          pin.style.left = r.left + 'px';
          pin.style.width = r.width + 'px';
        }

        // Alinear el texto con el logo (un poco debajo del inicio del logo)
        // Logo está en: navbarHeight + logoMarginTop
        // Usamos un valor fijo responsive basado en el viewport
