        ...
        >
          ...
          >
            ...
            <div className="flex flex-col md:flex-row max-h-[85vh] overflow-auto">
              {/* Imagen grande */}
              <div className="md:w-2/3 bg-gray-900 flex flex-col items-center justify-start p-4 relative">
                ...
                {/* Fotos de detalle */}
                {obraModal.obra.fotos_detalle_urls &&
                 Array.isArray(obraModal.obra.fotos_detalle_urls) &&
                 obraModal.obra.fotos_detalle_urls.length > 0 && (
                  <div className="w-full bg-gray-800 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                      {obraModal.obra.fotos_detalle_urls.map((url, idx) => (
                        <a
                          key={idx}
                          href={url}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group relative aspect-square rounded-lg overflow-hidden bg-gray-700 hover:ring-2 hover:ring-white transition-all"
                        >
                          <img
                            src={url}
                            alt={`Detalle ${idx + 1}`}
