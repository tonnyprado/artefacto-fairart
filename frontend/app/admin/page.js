...
import PreRegistrosTable from '@/components/admin/PreRegistrosTable'
...
const TABS = [
  ...
  { id: 'preregistros', label: 'Pre-registros', icon: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z' },
  ...
  return (
    <div className="admin-panel font-sans" style={{ minHeight: '100vh', backgroundColor: COLORS.cream }}>
      ...
      <main style={{
        ...
        {/* Pre-registros Tab */}
        {activeTab === 'preregistros' && <PreRegistrosTable />}
